        ...
        <div>
            ...
            <div style={{marginTop:12}}>
                ...
                <div
                    ...
                    className="dropzone"
                    style={{marginTop:6,padding:20,border:'2px dashed rgba(31,41,51,0.08)',borderRadius:8,display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',minHeight:100,cursor:'pointer'}}
